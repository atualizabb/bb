...
<input type="tel" ng-model="cpf" name="cpf" id="cpf" salta-campo-pos-preenchimento="pass6" focus="focus" data-ng-required="!vm.isCampoPreenchido(vm.tel_fone)" data-ng-focus="!vm.isCampoPreenchido(vm.tel_fone)" data-ng-model="vm.tel_fone" data-autofocus="" clean="true" data-bb-input-tel_fone="" data-salta-campo-pos-preenchimento="" class="cpfOuCnpj" maxlength="15" required="required" aria-invalid="true" onKeyPress="MascaraFoneDDD(event, this);" autofocus>
                             

							 <label class="has-text-lefted">CPF</label>
                            </div>
